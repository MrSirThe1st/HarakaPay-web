      ...
      {isAdmin && (
        <div className="space-y-6">
          <div className="bg-gradient-to-r from-blue-500 to-purple-600 text-white p-6 rounded-lg">
            ...
            <p className="opacity-90">Manage schools, monitor transactions, and oversee the entire platform</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            >
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="text-xl font-semibold text-gray-900">Create School</h3>
                  <p className="text-gray-600 mt-2">Register new schools on the platform</p>
                </div>
            ...
            >
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="text-xl font-semibold text-gray-900">Create Admin</h3>
                  <p className="text-gray-600 mt-2">Add new platform administrators</p>
                </div>
            ...
            >
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="text-xl font-semibold text-gray-900">Platform Reports</h3>
                  <p className="text-gray-600 mt-2">View comprehensive analytics</p>
                </div>
            ...
            >
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="text-xl font-semibold text-gray-900">Transaction Monitoring</h3>
                  <p className="text-gray-600 mt-2">Monitor all platform payments</p>
                </div>
            ...
            >
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-gray-600 mt-2">Configure platform policies</p>
                </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow border-l-4 border-indigo-500">
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="text-xl font-semibold text-gray-900">Schools Overview</h3>
                  <p className="text-gray-600 mt-2">Quick stats and management</p>
      ...
      {isSchoolStaff && (
        <div className="space-y-6">
          <div className="bg-gradient-to-r from-green-500 to-blue-600 text-white p-6 rounded-lg">
            ...
            <p className="opacity-90">Manage your school&apos;s students, fees, and communications</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            >
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-gray-600 mt-2">Manage your school&apos;s student database</p>
                </div>
                <svg className="w-8 h-8 text-blue-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            >
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="text-xl font-semibold text-gray-900">Fee Management</h3>
                  <p className="text-gray-600 mt-2">Track payments and manage fees</p>
                </div>
                <svg className="w-8 h-8 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1" />
                </svg>
